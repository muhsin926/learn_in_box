  ...
  return (
    <>
      <MiniHeader
        ...
        description={
          "Speak naturally with professional online Mentor from 185 countries"
        }
        round={true}
      />
      <section>
        <div className="w-full px-3 grid sm:px-10 grid-cols-12 mt-10">
          {onlineMentor?.map((feature) => (
            <div
              key={feature?.id}
              className="md:col-span-6 col-span-12 lg:col-span-3 flex flex-col items-center text-center p-5"
            >
