  ...
  return (
    <section className="mt-16 px-2 relative mb-10">
      ...
      <div className="flex flex-col items-center gap-5 mt-10 text-center">
        <h1 className="capitalize font-semibold text-3xl">Hundreds of thousands students join us monthly</h1>
        <p className="capitalize font-medium text-xl">and achieve their learning goals. With our expert tutors, your goals are closer than ever!</p>
        <Button
        title={'Start Learning'}
        stlye={'py-3 px-5 bg-[#3eb4be] rounded-md text-white font-semibold text-xl'}
        />
      </div>
    </section>
  );
