                ...
                <>
                  <div className="flex mb-2 bg-gray-200 rounded-lg  mx-16">
                    ...
                    <div className="grid grid-cols-12 px-2 pt-2">
                      <div className="col-span-8">
                        ...
                        <p className="text-xs">{mentors[0]?.message}</p>
                      </div>
                  ...
                  <div className="grid grid-cols-12 p-3">
                    <div className="col-span-8">
                      ...
                      <div className="flex">
                        <p className="text-xs">{mentors[1]?.lessons} Lessons</p>
                        <li className="text-xs">
                          Speaks English{" "}
                          <span className="text-[#3eb4be]">
                  ...
                  <div className="grid grid-cols-12 p-3">
                    <div className="col-span-8">
                      ...
                      <div className="flex">
                        <p className="text-xs">{mentors[2]?.lessons} Lessons</p>
                        <li className="text-xs">
                          Speaks English{" "}
                          <span className="text-[#3eb4be]">
                      ...
                      <p className="text-xs">{mentors[2]?.message}</p>
                    </div>
                    <div className="col-span-4 flex flex-col items-center">
                      <div className="flex gap-4">
                        <div>
