    ...
    return (
        <section className="mt-48">
            ...
            <div className="flex justify-center mt-14 items-center">
                ...
                <h1 className="capitalize text-zinc-700">Or view the following courses...</h1>
            </div>
                    ...
                    <div className="">
                        <ul>
                            {findCourse.slice(0, 5)?.map((course) => (
                                <li className="mb-5 font-semibold text-2xl text-gray-700" key={course?.id} >{course?.title}</li>
                            ))}
                        </ul>
                    </div>
                    <div>
