    ...
    <footer className="mx-10 mt-24 mb-10">
      ...
      <div className="grid grid-cols-12 pt-10">
        <div className="col-span-12  lg:col-span-4 mb-5">
          ...
          <p>
            LearnInbox platform doesn’t guarantee on your academic success.
            LearnInbox intended to start your own research and development.
          </p>
            ...
            <ul>
              {data?.points?.map((point) => (
                <li className="list-disc">
                  <a href={point?.href} target="blank">
                    {point?.text}
                  </a>
                </li>
              ))}
